...
fetchDataFromServer(
  ...
  function (movie) {
    ...
    document.title = `${title} - Matrix Plus`;
    ...
    <div class="detail-box">
      ...
      <div class="title-wrapper">
        <h3 class="title-large">Trailers e Clipes</h3>
      </div>
...
const addSuggestedMovies = function ({ results: movieList }, title) {
  ...
  movieListElem.ariaLabel = "Você também pode gostar";

  movieListElem.innerHTML = `
      <div class="title-wrapper">
        <h3 class="title-large">Você também pode gostar</h3>
      </div>
